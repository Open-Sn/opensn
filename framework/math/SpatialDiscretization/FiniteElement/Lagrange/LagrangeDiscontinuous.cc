...
size_t
LagrangeDiscontinuous::GetNumGhostDOFs(const UnknownManager& unknown_manager) const
{
  return 0;
}

std::vector<int64_t>
LagrangeDiscontinuous::GetGhostDOFIndices(const UnknownManager& unknown_manager) const
{
  return {};
}
