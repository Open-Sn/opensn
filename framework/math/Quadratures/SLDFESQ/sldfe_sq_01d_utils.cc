...
double
chi_math::SimplifiedLDFESQ::Quadrature::ComputeSphericalQuadrilateralArea(
...
std::array<double, 4>
chi_math::SimplifiedLDFESQ::Quadrature::IntegrateLDFEShapeFunctions(
  ...
  const std::vector<double>& legendre_qweights)
{
  ...
  auto EvaluateShapeFunction =
    [](chi_math::DynamicVector<double>& shape_coeffs, chi_mesh::Vector3& mu_eta_xi)
  {
...
void
chi_math::SimplifiedLDFESQ::Quadrature::CopyToAllOctants()
{
...
void
chi_math::SimplifiedLDFESQ::Quadrature::PopulateQuadratureAbscissae()
{
  abscissae_.clear();
  weights_.clear();
  omegas_.clear();
