...
double
chi_math::SimplifiedLDFESQ::Quadrature::RiemannIntegral(BaseFunctor* F, int Ni)
{
 ...
 * supplied SQs.*/
double
chi_math::SimplifiedLDFESQ::Quadrature::QuadratureSSIntegral(BaseFunctor* F)
{
...
void
chi_math::SimplifiedLDFESQ::Quadrature::TestIntegration(int test_case,
                                                        double ref_solution,
                                                        int RiemannN)
{
