...
chi_math::SimplifiedLDFESQ::Quadrature::SplitSQ(SphericalQuadrilateral& sq,
...
void
chi_math::SimplifiedLDFESQ::Quadrature::LocallyRefine(const chi_mesh::Vector3& ref_dir,
