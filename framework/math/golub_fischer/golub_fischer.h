...
/**
 * Implementation of the GolubFischer Modified ChebyShev Algorithm (MCA) to find moment-preserving
 * angles from a set of moments computed for the expansion of an angular function in Legendre
 * polynomials.
 *
