...
QuadratureTriangle::QuadratureTriangle(QuadratureOrder order) : SpatialQuadrature(order)
{
  switch (order)
  {
    ...
    {
      qpoints_ = { { 3.333333333333332593e-01, 3.333333333333334259e-01, 0.0 } };
      weights_ = {   5.000000000000000000e-01 };
      break;
    }
    case QuadratureOrder::SECOND:
    {
      qpoints_ = { { 1.666666666666666019e-01, 1.666666666666667962e-01, 0.0 },
    ...
    {
      qpoints_ = { { 4.459484909159648347e-01, 1.081030181680702890e-01, 0.0 },
      ...
      weights_ = {   1.116907948390057498e-01,
    ...
    default:
    {
      throw std::invalid_argument(std::string(__FUNCTION__) + " Invalid triangular quadrature order");
    }
  }
}
