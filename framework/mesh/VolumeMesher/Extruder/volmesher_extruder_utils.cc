...
void
chi_mesh::VolumeMesherExtruder::SetupLayers(int default_layer_count)
{
...
chi_mesh::Vector3
chi_mesh::VolumeMesherExtruder::ProjectCentroidToLevel(const chi_mesh::Vector3& centroid,
                                                       const size_t level)
{
...
int
chi_mesh::VolumeMesherExtruder::GetCellKBAPartitionIDFromCentroid(chi_mesh::Vector3& centroid)
{
...
bool
chi_mesh::VolumeMesherExtruder::HasLocalScope(const chi_mesh::Cell& template_cell,
...
chi_mesh::VolumeMesherExtruder::MakeExtrudedCell(const chi_mesh::Cell& template_cell,
                                                 ...
                                                 size_t num_template_cells)
{
  ...
  //========================================= Create polyhedron
  auto cell = std::make_unique<chi_mesh::Cell>(CellType::POLYHEDRON, extruded_subtype);
