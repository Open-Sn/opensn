 ...
 * unpartitioned mesh.*/
class chi_mesh::VolumeMesherPredefinedUnpartitioned : public chi_mesh::VolumeMesher
{
private:
  std::shared_ptr<const chi_mesh::UnpartitionedMesh> umesh_ptr_ = nullptr;

public:
  explicit VolumeMesherPredefinedUnpartitioned(
  ...
  static bool CellHasLocalScope(const chi_mesh::UnpartitionedMesh::LightWeightCell& lwcell,
  ...
  MakeCell(const chi_mesh::UnpartitionedMesh::LightWeightCell& raw_cell,
           uint64_t global_id,
