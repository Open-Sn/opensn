...
bool
chi_mesh::mesh_cutting::CheckPolyhedronQuality(const MeshContinuum& mesh,
 ...
 * index face_index.*/
std::set<size_t>
chi_mesh::mesh_cutting::FindNeighborFaceIndices(
  const std::vector<std::vector<uint64_t>>& proxy_faces, const size_t face_index)
{
...
std::vector<chi_mesh::mesh_cutting::Edge>
chi_mesh::mesh_cutting::FindNonManifoldEdges(const std::vector<std::vector<uint64_t>>& proxy_faces)
{
...
std::vector<chi_mesh::mesh_cutting::Edge>
chi_mesh::mesh_cutting::StitchEdgesEndToEnd(const std::vector<Edge>& edges)
{
...
void
chi_mesh::mesh_cutting::PopulatePolyhedronFromFaces(
