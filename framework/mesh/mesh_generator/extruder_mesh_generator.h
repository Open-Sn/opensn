 ...
 * parameters: Pair A = "n" and "z", or Pair B = "n" and "h". When pair A is used then the layer
 * heights h will be computed automatically. Vice versa, when pair B is used then the z-levels will
 * be computed automatically. Layers can be specified with a mixture of Pair A and Pair B. For
 * example: Two main layers, one specified using a height, and the other specified using a z-level.
 */
