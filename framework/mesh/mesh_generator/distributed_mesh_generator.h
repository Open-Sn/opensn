...
public:
   ...
   *
   * \return InputParameters Input parameters for configuring the DistributedMeshGenerator.
   */
...
private:
   ...
   * \return ByteArray The serialized mesh data for location 0.
   */
   ...
   * \return DistributedMeshData The deserialized mesh data.
   */
   ...
   * boundaries.
   * \return std::shared_ptr<MeshContinuum> A shared pointer to the local mesh.
   */
