...
void wrap_solver(py::module &slv)
{
  ...
  solver.def("Execute", &Solver::Execute, "Execute the solver.");
  solver.def("Step", &Solver::Step, "Step the solver.");
  solver.def("Advance", &Solver::Advance, "Advance time values function.");
