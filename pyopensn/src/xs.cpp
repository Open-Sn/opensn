...
#include "framework/materials/multi_group_xs/multi_group_xs.h"  // opensn::MultiGroupXS

#define XS_GETTER(method_name)                                                                                          \
    [](MultiGroupXS & self) { return convert_vector(self.method_name()); }

namespace opensn {

// Wrap multi-group cross section
static void wrap_multigroup_xs(py::module & xs) {
...
static void wrap_create_load(py::module & xs) {
    xs.def(
