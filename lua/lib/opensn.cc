...
static bool reg = opensnlua::Console::Bind(
  [](lua_State* L)
  {
    ...
    luabridge::getGlobalNamespace(L)
      ...
      .addFunction("ExportToOBJFile", &SurfaceMesh::ExportToOBJFile)
      .addFunction("ExportToPolyFile", &SurfaceMesh::ExportToPolyFile)
      .endClass()
    ...
    luabridge::getGlobalNamespace(L)
      ...
      .addProperty("num_groups", &MultiGroupXS::NumGroups)
      .addProperty("scattering_order", &MultiGroupXS::ScatteringOrder)
      .addProperty("num_precursors", &MultiGroupXS::NumPrecursors)
      .addProperty("is_fissionable", &MultiGroupXS::IsFissionable)
      .addProperty("scaling_factor", &MultiGroupXS::ScalingFactor)
      .addProperty("sigma_t", &MultiGroupXS::SigmaTotal)
      .addProperty("sigma_a", &MultiGroupXS::SigmaAbsorption)
      .addProperty("sigma_f", &MultiGroupXS::SigmaFission)
      .addProperty("chi", &MultiGroupXS::Chi)
      .addProperty("nu_sigma_f", &MultiGroupXS::NuSigmaF)
      .addProperty("nu_prompt_sigma_f", &MultiGroupXS::NuPromptSigmaF)
      .addProperty("nu_delayed_sigma_f", &MultiGroupXS::NuDelayedSigmaF)
      .addProperty("inv_velocity", &MultiGroupXS::InverseVelocity)
      .endClass()
    ...
    luabridge::getGlobalNamespace(L)
      ...
      .addFunction("PopulationPrev", &PRKSolver::PopulationPrev)
      .addFunction("PopulationNew", &PRKSolver::PopulationNew)
      .addFunction("Period", &PRKSolver::Period)
      .addFunction("TimePrev", &PRKSolver::TimePrev)
      .addFunction("TimeNew", &PRKSolver::TimeNew)
      .addFunction("SolutionPrev", &PRKSolver::SolutionPrev)
      .addFunction("SolutionNew", &PRKSolver::SolutionNew)
