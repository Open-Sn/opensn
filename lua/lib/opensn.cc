...
#include "modules/linear_boltzmann_solvers/solvers/lbs_steady_state.h"
...
static bool reg = opensnlua::Console::Bind(
  [](lua_State* L)
  {
    ...
    luabridge::getGlobalNamespace(L)
      ...
      .addFunction("SetOptions", &DiffusionSolverBase::SetOptions)
      .addFunction("SetBoundaryOptions", &DiffusionSolverBase::SetBoundaryOptions)
      .endClass()
      //
    ...
    luabridge::getGlobalNamespace(L)
      ...
      .addFunction("AddResponseBuffers", &ResponseEvaluator::AddResponseBuffers)
      .endClass()
