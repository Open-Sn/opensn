...
For meshing, we recommend users to utilize mesh generators that can generate
...
We also provide an in-house meshing capability for orthogonal grids (in 1D, 2D,
and 3D).
