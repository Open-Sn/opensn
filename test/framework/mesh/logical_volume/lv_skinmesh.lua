...
VolumeMesherSetProperty(MATID_FROMLOGICAL,vol0,10)
...
VolumeMesherSetProperty(MATID_FROMLOGICAL,vol1,11)
...
-- [old syntax] lv_skinmesh = LogicalVolumeCreate(SURFACE, surfmesh)
-- assign mat ID 15 to lv of skin mesh
VolumeMesherSetProperty(MATID_FROMLOGICAL,lv_skinmesh,15)

-- export to vtk
MeshHandlerExportMeshToVTK("lv_skinmesh_out")
