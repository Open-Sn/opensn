...
"""
3D 172G KEigenvalue::Solver test using power iteration and OpenMC MGXS library and dual quadrature
...
if __name__ == "__main__":
    ...
    pquad1 = GLCProductQuadrature3DXYZ(n_polar=2, n_azimuthal=4, scattering_order=1)
    pquad2 = GLCProductQuadrature3DXYZ(n_polar=4, n_azimuthal=4, scattering_order=1)
    ...
    phys = DiscreteOrdinatesProblem(
        ...
        groupsets=[
            ...
            {
                "groups_from_to": (64, num_groups - 1),
