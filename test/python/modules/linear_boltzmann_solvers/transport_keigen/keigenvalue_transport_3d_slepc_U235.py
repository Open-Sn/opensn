...
if "opensn_console" not in globals():
    ...
    from pyopensn.solver import DiscreteOrdinatesProblem, SLEPcKEigenSolver
        ...
        groupsets=[
            {
                ...
                "angular_quadrature": GLCProductQuadrature3DXYZ(n_polar=2,
                                                                n_azimuthal=4,
                                                                scattering_order=0),
