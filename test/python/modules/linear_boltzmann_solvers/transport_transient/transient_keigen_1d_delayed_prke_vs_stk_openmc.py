...
"""
1D delayed transient: OpenMC XS homogeneous step vs PRKE.
...
if __name__ == "__main__":
    ...
    xs_crit.LoadFromOpenMC("xs1g_delayed_crit_1p.h5", "set1", 294.0)

    xs_super = MultiGroupXS()
    xs_super.LoadFromOpenMC("xs1g_delayed_super_1p.h5", "set1", 294.0)
