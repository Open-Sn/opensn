...
"""
3D delayed transient: OpenMC XS homogeneous step vs PRKE (2 precursors).
...
Transport cross sections are loaded from OpenMC MGXS HDF5 files. The PRKE
reference values use the same benchmark precursor constants as the original
OpenSn XS source.
...
if __name__ == "__main__":
    ...
    xs_crit.LoadFromOpenMC("xs1g_delayed_crit_2p.h5", "set1", 294.0)

    xs_super = MultiGroupXS()
    xs_super.LoadFromOpenMC("xs1g_delayed_super_2p.h5", "set1", 294.0)
