...
"""
1D delayed transient: step XS change with precursors.

Test intent
- Minimal 1D delayed-neutron case to ensure precursor coupling is active in 1D and BCs are handled correctly.

Physics
- 1-group, 1 precursor. Step in nu*Sigma_f; delayed source responds through precursor evolution.
...
- TRANSIENT_OK ensures positive response after stepping.
"""
