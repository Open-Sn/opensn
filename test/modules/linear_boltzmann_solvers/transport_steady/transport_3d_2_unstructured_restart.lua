...
num_groups = 1
mat.SetProperty(materials[1], TRANSPORT_XSECTIONS, OPENSN_XSFILE, "simple_scatter_sgt1000_sigs999.9.xs")
mat.SetProperty(materials[2], TRANSPORT_XSECTIONS, OPENSN_XSFILE, "simple_scatter_sgt1000_sigs999.9.xs")
...
lbs_options =
{
  ...
  read_restart_data = true,
  read_restart_directory_name = "transport_3d_2_unstructured_restart", 
  read_restart_file_stem = "transport_3d_2_unstructured"
}
