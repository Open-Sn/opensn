...
void
lbs::DiscreteOrdinatesSolver::ScalePhiVector(PhiSTLOption which_phi, double value)
{
...
void
lbs::DiscreteOrdinatesSolver::SetGSPETScVecFromPrimarySTLvector(LBSGroupset& groupset,
                                                                Vec x,
...
/**Assembles a vector for a given groupset from a source vector.*/
void
lbs::DiscreteOrdinatesSolver::SetPrimarySTLvectorFromGSPETScVec(LBSGroupset& groupset,
                                                                Vec x_src,
                                                                PhiSTLOption which_phi)
{
  std::vector<double>* y_ptr;
...
/**Assembles a vector for a given groupset from a source vector.*/
void
lbs::DiscreteOrdinatesSolver::GSScopedCopyPrimarySTLvectors(LBSGroupset& groupset,
...
void
lbs::DiscreteOrdinatesSolver::SetMultiGSPETScVecFromPrimarySTLvector(const std::vector<int>& gs_ids,
                                                                     Vec x,
                                                                     PhiSTLOption which_phi)
{
  const std::vector<double>* y_ptr;
...
void
lbs::DiscreteOrdinatesSolver::SetPrimarySTLvectorFromMultiGSPETScVecFrom(
