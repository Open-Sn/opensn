...
public:
  ...
  /**
   * Functions of type MomentCallbackF can be added to the moment_callbacks vector and these can be
   * called from within functions taking a LBSGroupset instance. The intention is that this function
   * can be used as a general interface to retrieve angular flux values
   */
