...
void
TimeDependentSourceSolver::PreAdvance(std::function<void()> callback)
{
  pre_advance_callback_ = std::move(callback);
}

void
TimeDependentSourceSolver::PreAdvance(std::nullptr_t)
{
  pre_advance_callback_ = nullptr;
}

void
TimeDependentSourceSolver::PostAdvance(std::function<void()> callback)
{
  post_advance_callback_ = std::move(callback);
}

void
TimeDependentSourceSolver::PostAdvance(std::nullptr_t)
{
