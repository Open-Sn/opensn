 ...
 * offsets into the bank's contiguous storage for every cell face.
 */
class OutflowBank
{
public:
...
private:
  /**
   * Group-wise outflow values for all local faces.
   ...
   * Each offset points to the first energy group for the face.
   */
