...
struct AAHSweepData
{
  ...
  size_t group_block_size;            // used by fixed-N/AVX path
};
...
/// Generic CPU sweep kernel (scalar), parameterized by time dependence.
template <bool time_dependent>
inline void
AAH_CPUSweep_Generic(AAHSweepData& data, AngleSet& angle_set)
{
...
void AAH_CPUSweep_FixedN(AAHSweepData& data, AngleSet& angle_set);
