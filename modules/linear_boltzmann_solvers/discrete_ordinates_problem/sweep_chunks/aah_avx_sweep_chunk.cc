...
void
AAH_CPUSweep_FixedN(AAHSweepData& data, AngleSet& angle_set)
{
  static_assert(NumNodes >= 1 and NumNodes <= 8);

  CALI_CXX_MARK_SCOPE("AAH_CPUSweep_FixedN");
  ...
  for (size_t spls_index = 0; spls_index < num_spls; ++spls_index)
  {
    ...
    OpenSnInvalidArgumentIf(cell_num_nodes != expected_nodes,
                            "AAH_CPUSweep_FixedN invoked for an incompatible cell topology.");
...
AAHSweepChunk::CPUSweep_FixedN(AngleSet& angle_set)
{
  ...
  AAH_CPUSweep_FixedN<NumNodes, false>(data, angle_set);
}

template void AAH_CPUSweep_FixedN<2, false>(AAHSweepData&, AngleSet&);
template void AAH_CPUSweep_FixedN<3, false>(AAHSweepData&, AngleSet&);
template void AAH_CPUSweep_FixedN<4, false>(AAHSweepData&, AngleSet&);
template void AAH_CPUSweep_FixedN<5, false>(AAHSweepData&, AngleSet&);
template void AAH_CPUSweep_FixedN<6, false>(AAHSweepData&, AngleSet&);
template void AAH_CPUSweep_FixedN<7, false>(AAHSweepData&, AngleSet&);
template void AAH_CPUSweep_FixedN<8, false>(AAHSweepData&, AngleSet&);
template void AAH_CPUSweep_FixedN<2, true>(AAHSweepData&, AngleSet&);
template void AAH_CPUSweep_FixedN<3, true>(AAHSweepData&, AngleSet&);
template void AAH_CPUSweep_FixedN<4, true>(AAHSweepData&, AngleSet&);
template void AAH_CPUSweep_FixedN<5, true>(AAHSweepData&, AngleSet&);
template void AAH_CPUSweep_FixedN<6, true>(AAHSweepData&, AngleSet&);
template void AAH_CPUSweep_FixedN<7, true>(AAHSweepData&, AngleSet&);
template void AAH_CPUSweep_FixedN<8, true>(AAHSweepData&, AngleSet&);
