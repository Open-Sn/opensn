...
static inline void
update_range(std::vector<std::vector<double>>& target, std::vector<std::span<double>>& view)
{
...
AAH_FLUDS::AllocateOutgoingPsi(size_t num_grps, size_t num_angles, size_t num_loc_sucs)
{
  ...
  update_range(deplocI_outgoing_psi_, deplocI_outgoing_psi_view_);
}
...
AAH_FLUDS::AllocatePrelocIOutgoingPsi(size_t num_grps, size_t num_angles, size_t num_loc_deps)
{
  ...
  update_range(prelocI_outgoing_psi_, prelocI_outgoing_psi_view_);
}
                                             ...
                                             size_t num_loc_deps)
{
  ...
  update_range(delayed_prelocI_outgoing_psi_, delayed_prelocI_outgoing_psi_view_);
  update_range(delayed_prelocI_outgoing_psi_old_, delayed_prelocI_outgoing_psi_old_view_);
}
