...
{
  return delayed_face_flags_[face_offsets_[cell_local_id] + face_id] & LOCAL_INCOMING;
}
...
CBC_FLUDSCommonData::IsDelayedLocalOutgoingFace(std::uint32_t cell_local_id,
                                                unsigned int face_id) const
{
  return delayed_face_flags_[face_offsets_[cell_local_id] + face_id] & LOCAL_OUTGOING;
}
...
CBC_FLUDSCommonData::IsDelayedNonlocalIncomingFace(std::uint32_t cell_local_id,
                                                   unsigned int face_id) const
{
  return delayed_face_flags_[face_offsets_[cell_local_id] + face_id] & NONLOCAL_INCOMING;
}
...
CBC_FLUDSCommonData::IsDelayedNonlocalOutgoingFace(std::uint32_t cell_local_id,
                                                   unsigned int face_id) const
{
  return delayed_face_flags_[face_offsets_[cell_local_id] + face_id] & NONLOCAL_OUTGOING;
}
