...
/**
 * \brief Node Index specific to CBCD FLUDS.
 * \details Does not support delayed nodes. Reclaims the delayed bit for indices.
...
/**
 * \brief Metadata for boundary face nodes.
 */
...
/**
 * \brief Metadata for non-local face nodes.
 */
