...
public:
  ...
  /// Copies outgoing boundary psi from device to host
  void CopyOutgoingBoundaryPsiToHost(SweepChunk& sweep_chunk, std::vector<Task*>& tasks);
  ...
  /// Copies outgoing non-local psi from device to host
  void CopyOutgoingNonLocalPsiToHost(SweepChunk& sweep_chunk, std::vector<Task*>& tasks);
...
private:
  ...
  /// Map from outgoing face boundary node to indexing metadata
  std::vector<BoundaryNodeInfo> outgoing_boundary_node_map_;

  /// Map from incoming face non-local node to indexing metadata
  std::vector<NonLocalNodeInfo> incoming_nonlocal_node_map_;

  /// Map from outgoing face non-local node to indexing metadata
  std::vector<NonLocalNodeInfo> outgoing_nonlocal_node_map_;
