...
/**
 * \brief Base class for 64-bit integer encoding the index and bank information of a face node.
 * \details This base class manages the common bits:
...
/**
 * \brief Base pointer set for FLUDs on the device.
 * \details Holds the common pointers and stride information shared between
