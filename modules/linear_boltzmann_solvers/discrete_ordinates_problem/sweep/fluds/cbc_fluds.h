...
public:
  ...
  /// Return the number of psi values expected for an immediate nonlocal face slot.
  std::size_t GetIncomingNonlocalPsiSize(std::size_t incoming_face_slot) const noexcept;
