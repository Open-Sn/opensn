...
struct CMFDCoarseFace
{
  ...
  Vector3 neighbor_centroid;
  Vector3 normal;
  Vector3 centroid;
  double area = 0.0;
  std::vector<CMFDFineFace> fine_faces;
};

struct CMFDCoarseCell
{
...
public:
  ...
  size_t NumLocalCells() const { return local_cells_.size(); }
  size_t NumGlobalCells() const { return num_global_cells_; }
