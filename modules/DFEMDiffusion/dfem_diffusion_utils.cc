...
double
dfem_diffusion::Solver::HPerpendicular(const chi_mesh::Cell& cell, unsigned int f)
{
  ...
  else if (cell.Type() == chi_mesh::CellType::POLYHEDRON)
  {
    ...
    throw std::logic_error("dfem_diffusion::Solver::HPerpendicular: "
...
int
dfem_diffusion::Solver::MapFaceNodeDisc(const chi_mesh::Cell& cur_cell,
                                        ...
                                        double epsilon /*=1.0e-12*/)
{
  ...
  throw std::logic_error("dfem_diffusion::Solver::MapFaceNodeDisc: Mapping failure.");
}
...
double
dfem_diffusion::Solver::CallLua_iXYZFunction(lua_State* L,
                                             ...
                                             const chi_mesh::Vector3& xyz)
{
  ...
  if (lua_pcall(L, 4, 1, 0) == 0)
  {
    ...
    throw std::logic_error("dfem_diffusion::CallLua_iXYZFunction attempted to call lua-function, " +
                           lua_func_name + ", but the call failed." + xyz.PrintStr());
...
void
dfem_diffusion::Solver::UpdateFieldFunctions()
{
