  ...
  for (uint64_t bndry_id : globl_unique_bndry_ids)
  {
    ...
    if (boundary_preferences_.find(bndry_name) != boundary_preferences_.end())
    {
      ...
      switch (bndry_info.first)
      {
        ...
        {
          boundaries_.insert(std::make_pair(bndry_id, new chi_diffusion::BoundaryReflecting()));
        ...
        case BoundaryType::Dirichlet:
        {
          ...
          boundaries_.insert(
            std::make_pair(bndry_id, new chi_diffusion::BoundaryDirichlet(bndry_vals[0])));
        ...
        case BoundaryType::Robin:
        {
          ...
          boundaries_.insert(std::make_pair(
            bndry_id,
            new chi_diffusion::BoundaryRobin(bndry_vals[0], bndry_vals[1], bndry_vals[2])));
        ...
        {
          boundaries_.insert(
            std::make_pair(bndry_id, new chi_diffusion::BoundaryRobin(0.25, 0.5, 0.0)));
    ...
    {
      boundaries_.insert(std::make_pair(bndry_id, new chi_diffusion::BoundaryDirichlet()));
