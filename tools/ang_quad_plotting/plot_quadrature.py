...
#====================================== Declare File Base to read (User Edit)
fileBase = "TestQuad1_"

currentDirect = Path(__file__).parent
vertPath = currentDirect / 'plotting_data' / (fileBase + "verts.csv")
cellPath = currentDirect / 'plotting_data' / (fileBase + "cells.csv")
pointPath = currentDirect / 'plotting_data' / (fileBase + "points.csv")
